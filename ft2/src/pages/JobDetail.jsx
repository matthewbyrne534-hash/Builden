...
import { Breadcrumb, Badge, Modal, FormGroup, Input, Select, EmptyState, ConfirmModal, Notice } from '../components/UI';
...
export default function JobDetail({ jobId, navigate }) {
  ...
  const total = job.packages.reduce((s, p) => s + calcPackageTotals(p, job).grand, 0);
